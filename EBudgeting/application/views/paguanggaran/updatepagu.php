            ...
            <div class="card card-primary">
                ...
                <form action="<?php site_url('C_paguanggaran/edit') ?>" method="post">
                    <?php foreach ($paguanggaran as $key) : ?>
                        ...
                        <input type="text" name="nominal_pagu" placeholder="nominal_pagu" value="<?php echo $key['nominal_pagu']; ?>">
                        <input type="text" name="nominal_terpakai" placeholder="nominal_terpakai" value="<?php echo $key['nominal_terpakai']; ?>">
