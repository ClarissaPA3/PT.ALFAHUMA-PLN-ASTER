                ...
                <form role="form" action="<?php site_url('C_input_jabatan/update') ?>" method="post">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <label for="nama">Tingkat Jabatan</label>

                            <input type="text" class="form-control" id="tingkat" name="tingkat" placeholder="Tingkat Jabatan" value="<?php echo $jabatan['tingkatan_user']; ?>">
                        </div>
