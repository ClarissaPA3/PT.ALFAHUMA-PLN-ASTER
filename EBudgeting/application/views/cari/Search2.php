        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <section class="content-header">
                    <h1>Filter Data Berdasarkan Minggu</h1>
                    </a>
                </section>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                <div class="box-body">
                                    <form action="<?= base_url('SearchController2/index/') ?>" method="get">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="keyword" placeholder="Minggu Ke...">
