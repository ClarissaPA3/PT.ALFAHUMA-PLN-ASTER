                        ...
                        <div class="table-responsive">
                            <table class="table table-hover text-center table-striped" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody class="table-striped">
                                    <tr>
                                        <td>1</td>
                                        <td>Dashboard Sub Bidang</td>
                                        <td>Tidak</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Dashboard DMPAU/ Admin</td>
                                        <td>Ya</td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>Dashboard DM/ Bidang</td>
                                        <td>Tidak</td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>Pengajuan Anggaran</td>
                                        <td>Tidak</td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        <td>Draft Anggaran</td>
                                        <td>Tidak</td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        <td>Persetujuan DM</td>
                                        <td>Tidak</td>
                                    </tr>
                                    <tr>
                                        <td>6</td>
                                        <td>Persetujuan DMPAU</td>
                                        <td>Ya</td>
                                    </tr>
                                    <tr>
                                        <td>7</td>
                                        <td>Koreksi Anggaran</td>
                                        <td>Ya</td>
                                    </tr>
                                    <tr>
                                        <td>8</td>
                                        <td>Rekapitulasi Anggaran</td>
                                        <td>Ya</td>
                                    </tr>
                                    <tr>
                                        <td>9</td>
                                        <td>Rekapitulasi Pos Anggaran</td>
                                        <td>Ya</td>
                                    </tr>
                                    <tr>
                                        <td>10</td>
