...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                ...
                                <div class="box-body">
                                    <form class="form-horizontal" id="ajuananggaran" action="<?php echo site_url('C_persetujuan_dmpau/reviewdmpau'); ?>" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" id="review-dm">
                                                ...
                                                ?>
                                                    ...
                                                    <textarea name="catatan_dmpau2" id="catatan_dmpau2" class="form-control" cols="30" rows="10"><?php echo $ajuan['catatan_dmpau2']; ?></textarea>
                                                <?php
                                                    # code...
                                                }
                                                ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            </div>').append('<label for="catatan_dmpau2">Catatan DMPAU</label>\
            <textarea name="catatan_dmpau2" id="catatan_dmpau2" class="form-control" cols="30" rows="10"></textarea>');
